...
<body>
    ...
    <div class="momentos-cont">
        ...
        <div class="momentos">
            <div class="bloques2 bloque3">
                <a href="https://www.fifa.com/fifaplus/es/articles/siete-momentos-inolvidables-copa-mundial-fifa-catar-2022"
                    target="_blank"><img class="img2" src="img/mejores-momentos.png"
    ...
    <div class="cuadro">
        ...
        <img class="img1" src="img/Cuadro_Mundial.png" alt="Cuadro del Mundial">
    </div>
    ...
    <div class="mascota">
        ...
        <div class="clasecreadaparacentrarundiv">
            <div class="bloque5">
                <h3>La'eeb</h3>
                <p>Laʿeeb es un kufiyya animado en forma infantil. Fue presentado por la FIFA y el Comité Organizador el
                    2
                    de abril de 2022 en el video de introducción en el marco del sorteo final. <br> Laʿeeb representa
                    una de las vestimentas típicas de Medio Oriente, pues es una kufiyya catarí que cuenta con su propio
                    agal, ojos, cejas y boca y está decorado. Tiene aspecto fantasmagórico, al no poseer extremidades y
                    además flotar, y se forma a partir del logotipo de la Copa Mundial de 2022. </p>
            </div>
        </div>
    </div>
        ...
        <div>
            <div class="tabla">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td class="td1">1. <img class="img4" src="img/NED.png" alt="NED"> NED</td>
                            <td>3</td>
                            <td>2</td>
                            <td>1</td>
                            <td>0</td>
                        ...
                        <tr>
                            <td class="td1">2. <img class="img4" src="img/SEN.png" alt="SEN"> SEN</td>
                            <td>3</td>
                            <td>2</td>
                            <td>0</td>
                            <td>1</td>
                        ...
                        <tr>
                            <td class="td1">3. <img class="img4" src="img/ECU.png" alt="ECU"> ECU</td>
                            <td>3</td>
                            <td>1</td>
                            <td>1</td>
                            <td>1</td>
                        ...
                        <tr>
                            <td class="td1">4. <img class="img4" src="img/QAT.png" alt="QAT"> QAT</td>
                            <td>3</td>
                            <td>0</td>
                            <td>0</td>
                            <td>3</td>
            ...
            <div class="tabla">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td class="td1">1. <img class="img4" src="img/ENG.png" alt="ENG"> ENG</td>
                            <td>3</td>
                            <td>2</td>
                            <td>1</td>
                            <td>0</td>
                        ...
                        <tr>
                            <td class="td1">2. <img class="img4" src="img/USA.png" alt="USA"> USA</td>
                            <td>3</td>
                            <td>1</td>
                            <td>2</td>
                            <td>0</td>
                        ...
                        <tr>
                            <td class="td1">3. <img class="img4" src="img/IRN.png" alt="IRN"> IRN</td>
                            <td>3</td>
                            <td>1</td>
                            <td>0</td>
                            <td>2</td>
                        ...
                        <tr>
                            <td class="td1">4. <img class="img4" src="img/WAL.png" alt="WAL"> WAL</td>
                            <td>3</td>
                            <td>0</td>
                            <td>1</td>
                            <td>2</td>
            ...
            <div class="tabla">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td class="td1">1. <img class="img4" src="img/ARG.png" alt="ARG"> ARG</td>
                            <td>3</td>
                            <td>2</td>
                            <td>0</td>
                            <td>1</td>
                        ...
                        <tr>
                            <td class="td1">2. <img class="img4" src="img/POL.png" alt="POL"> POL</td>
                            <td>3</td>
                            <td>1</td>
                            <td>1</td>
                            <td>1</td>
                        ...
                        <tr>
                            <td class="td1">3. <img class="img4" src="img/MEX.png" alt="MEX"> MEX</td>
                            <td>3</td>
                            <td>1</td>
                            <td>1</td>
                            <td>1</td>
                        ...
                        <tr>
                            <td class="td1">4. <img class="img4" src="img/KSA.png" alt="KSA"> KSA</td>
                            <td>3</td>
                            <td>1</td>
                            <td>0</td>
                            <td>2</td>
        ...
        <div>
            <div class="tabla">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td class="td1">1. <img class="img4" src="img/FRA.png" alt="FRA"> FRA</td>
                            <td>3</td>
                            <td>2</td>
                            <td>0</td>
                            <td>1</td>
                        ...
                        <tr>
                            <td class="td1">2. <img class="img4" src="img/AUS.png" alt="AUS"> AUS</td>
                            <td>3</td>
                            <td>2</td>
                            <td>0</td>
                            <td>1</td>
                        ...
                        <tr>
                            <td class="td1">3. <img class="img4" src="img/TUN.png" alt="TUN"> TUN</td>
                            <td>3</td>
                            <td>1</td>
                            <td>1</td>
                            <td>1</td>
                        ...
                        <tr>
                            <td class="td1">4. <img class="img4" src="img/DEN.png" alt="DEN"> DEN</td>
                            <td>3</td>
                            <td>0</td>
                            <td>1</td>
                            <td>2</td>
            ...
            <div class="tabla">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td class="td1">1. <img class="img4" src="img/JPN.png" alt="JPN"> JPN</td>
                            <td>3</td>
                            <td>2</td>
                            <td>0</td>
                            <td>1</td>
                        ...
                        <tr>
                            <td class="td1">2. <img class="img4" src="img/ESP.png" alt="ESP"> ESP</td>
                            <td>3</td>
                            <td>1</td>
                            <td>1</td>
                            <td>1</td>
                        ...
                        <tr>
                            <td class="td1">3. <img class="img4" src="img/GER.png" alt="GER"> GER</td>
                            <td>3</td>
                            <td>1</td>
                            <td>1</td>
                            <td>1</td>
                        ...
                        <tr>
                            <td class="td1">4. <img class="img4" src="img/CRC.png" alt="CRC"> CRC</td>
                            <td>3</td>
                            <td>1</td>
                            <td>0</td>
                            <td>2</td>
            ...
            <div class="tabla">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td class="td1">1. <img class="img4" src="img/MAR.png" alt="MAR"> MAR</td>
                            <td>3</td>
                            <td>2</td>
                            <td>1</td>
                            <td>0</td>
                        ...
                        <tr>
                            <td class="td1">2. <img class="img4" src="img/CRO.png" alt="CRO"> CRO</td>
                            <td>3</td>
                            <td>1</td>
                            <td>2</td>
                            <td>0</td>
                        ...
                        <tr>
                            <td class="td1">3. <img class="img4" src="img/BEL.png" alt="BEL"> BEL</td>
                            <td>3</td>
                            <td>1</td>
                            <td>1</td>
                            <td>1</td>
                        ...
                        <tr>
                            <td class="td1">4. <img class="img4" src="img/CAN.png" alt="CAN"> CAN</td>
                            <td>3</td>
                            <td>0</td>
                            <td>0</td>
                            <td>3</td>
        ...
        <div class="cont-juego">
            <div class="tabla">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td class="td1">1. <img class="img4" src="img/BRA.png" alt="BRA"> BRA</td>
                            <td>3</td>
                            <td>2</td>
                            <td>0</td>
                            <td>1</td>
                        ...
                        <tr>
                            <td class="td1">2. <img class="img4" src="img/SUI.png" alt="SUI"> SUI</td>
                            <td>3</td>
                            <td>2</td>
                            <td>0</td>
                            <td>1</td>
                        ...
                        <tr>
                            <td class="td1">3. <img class="img4" src="img/CMR.png" alt="CMR"> CMR</td>
                            <td>3</td>
                            <td>1</td>
                            <td>1</td>
                            <td>1</td>
                        ...
                        <tr>
                            <td class="td1">4. <img class="img4" src="img/SRB.png" alt="SRB"> SRB</td>
                            <td>3</td>
                            <td>0</td>
                            <td>1</td>
                            <td>2</td>
            ...
            <div class="tabla">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td class="td1">1. <img class="img4" src="img/POR.png" alt="POR"> POR</td>
                            <td>3</td>
                            <td>2</td>
                            <td>0</td>
                            <td>1</td>
                        ...
                        <tr>
                            <td class="td1">2. <img class="img4" src="img/KOR.png" alt="KOR"> KOR</td>
                            <td>3</td>
                            <td>1</td>
                            <td>1</td>
                            <td>1</td>
                        ...
                        <tr>
                            <td class="td1">3. <img class="img4" src="img/URU.png" alt="URU"> URU</td>
                            <td>3</td>
                            <td>1</td>
                            <td>1</td>
                            <td>1</td>
                        ...
                        <tr>
                            <td class="td1">4. <img class="img4" src="img/GHA.png" alt="GHA"> GHA</td>
                            <td>3</td>
                            <td>1</td>
                            <td>0</td>
                            <td>2</td>
